...
from sorsore import __version__
...
def global_admin_css():
    return format_html(
        ...
        static("sorsore/css/crx-admin.css"),
        __version__,
    )
...
def collapsible_js():
    return format_html(
        '<script src="{}?v={}"></script>',
        static("sorsore/js/crx-editor.js"),
        __version__,
    )
...
def register_icons(icons):
    ...
    icons.append("sorsore/icons/cr-align-left.svg")
    icons.append("sorsore/icons/cr-check-square-o.svg")
    icons.append("sorsore/icons/cr-columns.svg")
    icons.append("sorsore/icons/cr-desktop.svg")
    icons.append("sorsore/icons/cr-font.svg")
    icons.append("sorsore/icons/cr-google.svg")
    icons.append("sorsore/icons/cr-hand-pointer-o.svg")
    icons.append("sorsore/icons/cr-hashtag.svg")
    icons.append("sorsore/icons/cr-header.svg")
    icons.append("sorsore/icons/cr-list-alt.svg")
    icons.append("sorsore/icons/cr-map.svg")
    icons.append("sorsore/icons/cr-newspaper-o.svg")
    icons.append("sorsore/icons/cr-puzzle-piece.svg")
    icons.append("sorsore/icons/cr-recycle.svg")
    icons.append("sorsore/icons/cr-stop.svg")
    icons.append("sorsore/icons/cr-th-large.svg")
    icons.append("sorsore/icons/cr-universal-access.svg")
    icons.append("sorsore/icons/cr-usd.svg")
    icons.append("sorsore/icons/cr-window-maximize.svg")
    icons.append("sorsore/icons/cr-window-minimize.svg")
    return icons
...
def crx_forms(user, editable_forms):
    ...
    """
    from sorsore.models import CoderedFormMixin
