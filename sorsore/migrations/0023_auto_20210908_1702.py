...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('sorsore', '0022_auto_20210731_1853'),
    ]
    ...
    operations = [
        migrations.AddField(
            ...
            field=models.ForeignKey(blank=True, help_text='Child pages will first be sorted following the order of this classifier’s terms (from Snippets > Classifiers).', null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='+', to='sorsore.classifier', verbose_name='Order child pages by classifier'),
        ),
