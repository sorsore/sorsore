...
def copy_settings(apps, schema_editor):
    ...
    GeneralSettings = apps.get_model("sorsore", "GeneralSettings")
    GoogleApiSettings = apps.get_model("sorsore", "GoogleApiSettings")
    MailchimpApiSettings = apps.get_model("sorsore", "MailchimpApiSettings")
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('sorsore', '0034_delete_adasettings'),
    ]
