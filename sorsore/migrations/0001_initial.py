    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('content', sorsore.fields.CoderedStreamField([], blank=True)),
                ('carousel', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='carousel_slides', to='sorsore.Carousel', verbose_name='Carousel')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom_css_class', models.CharField(blank=True, max_length=255, verbose_name='Custom CSS Class')),
                ('custom_id', models.CharField(blank=True, max_length=255, verbose_name='Custom ID')),
                ('content', sorsore.fields.CoderedStreamField([], blank=True, verbose_name='Content')),
            ],
            options={
                'verbose_name': 'Footer',
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('custom_css_class', models.CharField(blank=True, max_length=255, verbose_name='Custom CSS Class')),
                ('custom_id', models.CharField(blank=True, max_length=255, verbose_name='Custom ID')),
                ('menu_items', sorsore.fields.CoderedStreamField([], blank=True, verbose_name='Navigation links')),
            ],
            options={
