...
class ColumnBlock(BaseLayoutBlock):
    ...
    class Meta:
        template = "sorsore/blocks/column_block.html"
        icon = "placeholder"
        label = "Column"
...
class GridBlock(BaseLayoutBlock):
    ...
    class Meta:
        template = "sorsore/blocks/grid_block.html"
        icon = "cr-columns"
...
class CardGridBlock(BaseLayoutBlock):
    ...
    class Meta:
        template = "sorsore/blocks/cardgrid_deck.html"
        icon = "cr-th-large"
        label = _("Card Grid")
...
class HeroBlock(BaseLayoutBlock):
    ...
    class Meta:
        template = "sorsore/blocks/hero_block.html"
        icon = "cr-newspaper-o"
        label = "Hero Unit"
