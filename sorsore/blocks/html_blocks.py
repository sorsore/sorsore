...
class ButtonBlock(ButtonMixin, BaseLinkBlock):
    ...
    class Meta:
        template = "sorsore/blocks/button_block.html"
...
class DownloadBlock(ButtonMixin, BaseBlock):
    ...
    class Meta:
        template = "sorsore/blocks/download_block.html"
        icon = "download"
        label = _("Download")
...
class EmbedGoogleMapBlock(BaseBlock):
    ...
    class Meta:
        template = "sorsore/blocks/google_map.html"
        icon = "cr-map"
        label = _("Google Map")
...
class EmbedVideoBlock(BaseBlock):
    ...
    class Meta:
        template = "sorsore/blocks/embed_video_block.html"
        icon = "media"
        label = _("Embed Media")
...
class H1Block(BaseBlock):
    ...
    class Meta:
        template = "sorsore/blocks/h1_block.html"
        icon = "cr-header"
        label = _("Heading 1")
...
class H2Block(BaseBlock):
    ...
    class Meta:
        template = "sorsore/blocks/h2_block.html"
        icon = "cr-header"
        label = _("Heading 2")
...
class H3Block(BaseBlock):
    ...
    class Meta:
        template = "sorsore/blocks/h3_block.html"
        icon = "cr-header"
        label = _("Heading 3")
...
class TableBlock(BaseBlock):
    ...
    class Meta:
        template = "sorsore/blocks/table_block.html"
        icon = "table"
        label = "Table"
...
class ImageBlock(BaseBlock):
    ...
    class Meta:
        template = "sorsore/blocks/image_block.html"
        icon = "image"
        label = _("Image")
...
class ImageLinkBlock(BaseLinkBlock):
    ...
    class Meta:
        template = "sorsore/blocks/image_link_block.html"
        icon = "image"
        label = _("Image Link")
        value_class = LinkStructValue
...
class PageListBlock(BaseBlock):
    ...
    class Meta:
        template = "sorsore/blocks/pagelist_block.html"
        icon = "list-ul"
...
class PagePreviewBlock(BaseBlock):
    ...
    class Meta:
        template = "sorsore/blocks/pagepreview_block.html"
...
class QuoteBlock(BaseBlock):
    ...
    class Meta:
        template = "sorsore/blocks/quote_block.html"
        icon = "openquote"
        label = _("Quote")
...
class RichTextBlock(blocks.RichTextBlock):
    class Meta:
        template = "sorsore/blocks/rich_text_block.html"
