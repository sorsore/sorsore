...
class AccordionBlock(BaseBlock):
    ...
    accordion = SnippetChooserBlock("sorsore.Accordion")

    class Meta:
        template = "sorsore/blocks/accordion_block.html"
        icon = "bars"
        label = "Accordion"
...
class CardBlock(BaseBlock):
    ...
    class Meta:
        template = "sorsore/blocks/card_foot.html"
        icon = "cr-list-alt"
        label = _("Card")
...
class CarouselBlock(BaseBlock):
    ...
    carousel = SnippetChooserBlock("sorsore.Carousel")

    class Meta:
        icon = "image"
        label = _("Carousel")
        template = "sorsore/blocks/carousel_block.html"
...
class FilmStripBlock(BaseBlock):
    ...
    film_strip = SnippetChooserBlock("sorsore.FilmStrip")

    class Meta:
        icon = "image"
        label = _("Film Strip")
        template = "sorsore/blocks/film_strip_block.html"
...
class ImageGalleryBlock(BaseBlock):
    ...
    class Meta:
        template = "sorsore/blocks/image_gallery_block.html"
        icon = "image"
...
class ModalBlock(ButtonMixin, BaseLayoutBlock):
    ...
    class Meta:
        template = "sorsore/blocks/modal_block.html"
...
class NavExternalLinkBlock(NavBaseLinkBlock):
    ...
    class Meta:
        template = "sorsore/blocks/external_link_block.html"
...
class NavPageLinkBlock(NavBaseLinkBlock):
    ...
    class Meta:
        template = "sorsore/blocks/page_link_block.html"
        label = _("Page Link")
...
class NavDocumentLinkBlock(NavBaseLinkBlock):
    ...
    class Meta:
        template = "sorsore/blocks/document_link_block.html"
...
class PriceListItemBlock(BaseBlock):
    ...
    class Meta:
        template = "sorsore/blocks/pricelistitem_block.html"
        icon = "cr-usd"
...
class PriceListBlock(BaseBlock):
    ...
    class Meta:
        template = "sorsore/blocks/pricelist_block.html"
        icon = "cr-usd"
        label = _("Price List")
...
class ContentWallBlock(BaseBlock):
    ...
    content_wall = SnippetChooserBlock("sorsore.ContentWall")
    ...
    class Meta:
        ...
        template = "sorsore/blocks/content_wall_block.html"
...
class ReusableContentBlock(BaseBlock):
    ...
    content = SnippetChooserBlock("sorsore.ReusableContent")

    class Meta:
        icon = "cr-recycle"
        label = _("Reusable Content")
        template = "sorsore/blocks/reusable_content_block.html"
