...
from sorsore.utils import attempt_protected_media_value_conversion
...
class CoderedDateInput(forms.DateInput):
    template_name = "sorsore/formfields/date.html"
...
class CoderedDateTimeInput(forms.DateTimeInput):
    template_name = "sorsore/formfields/datetime.html"
...
class CoderedTimeInput(forms.TimeInput):
    template_name = "sorsore/formfields/time.html"
...
def get_page_model_choices():
    ...
    """
    from sorsore.models import get_page_models
