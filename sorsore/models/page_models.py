...
from sorsore import utils
from sorsore.blocks import (
    CONTENT_STREAMBLOCKS,
    LAYOUT_STREAMBLOCKS,
    STREAMFORM_BLOCKS,
    ContentWallBlock,
)
from sorsore.fields import CoderedStreamField, ColorField
from sorsore.forms import CoderedFormBuilder, CoderedSubmissionsListView
from sorsore.models.snippet_models import ClassifierTerm
from sorsore.models.wagtailsettings_models import LayoutSettings
from sorsore.wagtail_flexible_forms.blocks import (
    FormFieldBlock,
    FormStepBlock,
)
from sorsore.wagtail_flexible_forms.models import (
    Step,
    Steps,
    StreamFormMixin,
...
class CoderedTag(TaggedItemBase):
    ...
    content_object = ParentalKey(
        "sorsore.CoderedPage", related_name="tagged_items"
    )
...
class CoderedPage(WagtailCacheMixin, SeoMixin, Page, metaclass=CoderedPageMeta):
    ...
    search_template = "sorsore/pages/search_result.html"

    # Template used for related pages, Latest Pages block, and Page Preview block.
    miniview_template = "sorsore/pages/page.mini.html"
    ...
    index_query_pagemodel = "sorsore.CoderedPage"
...
class CoderedFormPage(CoderedFormMixin, CoderedWebPage):
    ...
    miniview_template = "sorsore/pages/form_page.mini.html"
    landing_page_template = "sorsore/pages/form_page_landing.html"
...
class CoderedStreamFormPage(
    ...
    template = "sorsore/pages/stream_form_page.html"
    landing_page_template = "sorsore/pages/form_page_landing.html"
...
class CoderedLocationPage(CoderedWebPage):
    ...
    def render_pin_description(self):
        return render_to_string(
            "sorsore/includes/map_pin_description.html", {"page": self}
        )

    @property
    def render_list_description(self):
        return render_to_string(
            "sorsore/includes/map_list_description.html", {"page": self}
        )
...
class LandingPage(CoderedWebPage):
    ...
    template = "sorsore/pages/landing_page.html"

    body = StreamField([
        ("carousel", themes_body.CarouselBlock()),
        ("page_card_list", themes_body.PageCardBlock()),
        ("card_list", themes_body.CardListBlock()),
