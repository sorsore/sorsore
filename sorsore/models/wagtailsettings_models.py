...
Global project or developer settings should be defined in sorsore.settings.py .
"""
...
from sorsore.fields import MonospaceField
from sorsore.settings import crx_settings
from sorsore.models.snippet_models import Navbar, Footer
...
class LayoutSettings(ClusterableModel, BaseSiteSetting):
    ...
    choose_template = models.CharField(
        blank= True,
        max_length=50,
        choices=None,
        default=""
    ...
    def __init__(self, *args, **kwargs):
        ...
        self._meta.get_field("choose_template").choices = (
            crx_settings.SORSORE_TEMPLATE_CHOICES
        )
        ...
        if not self.id:
            ...
            self.choose_template = crx_settings.SORSORE_TEMPLATE_DEFAULT
